...
//        // Save the valid evaluations
//        Evaluation savedEvaluations = academicDeanService.saveEvaluations(evaluations);
    ...
    private String getAuthenticatedUsername() {
        ...
        return authentication.getName();  // Assuming the username is stored as the principal name
    }
}
