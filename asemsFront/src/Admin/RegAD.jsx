...
export default function RegAD() {
    ...
    const validateForm = () => {
        ...
        // Academic fields
        if (!inputRefs.current.highestDegree.value.trim()) {
            errors.highestDegree = "Highest degree is required";
        } else if (inputRefs.current.highestDegree.value.trim().length < 2) {
            errors.highestDegree = "Degree should be at least 2 characters";
        }

        if (!inputRefs.current.academicRank.value.trim()) {
            errors.academicRank = "Academic rank is required";
        } else if (inputRefs.current.academicRank.value.trim().length < 4) {
            errors.academicRank = "Rank should be at least 4 characters";
        }
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            Academic Dean registered successfully!
                        </div>
